...
ITERATE_NUM = 50
BATCH_SIZE = 32
calibration_store_dir = "/cs/oschulte/Galen/Hockey-data-entire/c4-Hockey-Training-All-feature{0}-scale-neg_reward".format(str(FEATURE_TYPE))
pre_initialize = True
if pre_initialize:
...
save_csv_name = home_or_away + "td_c4_cut_together_calibration_entire_feature_" + str(
    FEATURE_TYPE) + "_" + MODEL_TYPE + "_Iter" + str(ITERATE_NUM) + "_batch" + str(
    BATCH_SIZE) +pre_initialize_save + "_sum_2017-7-12.csv"
save_game_csv_name = home_or_away + "td_c4_cut_together_game_record_entire_feature_" + str(
    FEATURE_TYPE) + "_" + MODEL_TYPE + "_Iter" + str(ITERATE_NUM) + "_batch" + str(
    BATCH_SIZE) + pre_initialize_save + "_sum_2017-7-12.csv"

data_together_name = "model_c4_cut_together_predict_feature_" + str(
    FEATURE_TYPE) + "_" + MODEL_TYPE + "_Iter" + str(ITERATE_NUM) + "_batch" + str(
    BATCH_SIZE) + pre_initialize_save + ".mat"
data_together_name_load_name = "model_c4_cut_together_predict_feature_" + str(
