...
if Scale:
    DATA_STORE = "/cs/oschulte/Galen/Hockey-data-entire/State-c4-Hockey-Training-All-feature" + str(
        FEATURE_TYPE) + "-scale-neg_reward"

    LOG_DIR = save_mother_dir + "/oschulte/Galen/models/log_NN/State-Scale-c4-cut_log_entire_" + str(
    ...
    SAVED_NETWORK = save_mother_dir + "/oschulte/Galen/models/saved_NN/State-Scale-c4-cut_saved_entire_" + str(
    ...
    LOG_DIR = save_mother_dir + "/oschulte/Galen/models/log_NN/State-c4-cut_log_entire_" + str(
        Home_model_or_away_model) + "_train_feature" + str(
        FEATURE_TYPE) + "_batch" + str(BATCH_SIZE) + "_iterate" + str(
        ITERATE_NUM) + "_lr" + str(
        learning_rate) + "-" + str(
        REWARD_TYPE) + "_" + MODEL_TYPE + "-" + Random_or_Sequenced + pre_initialize_situation
    SAVED_NETWORK = save_mother_dir + "/oschulte/Galen/models/saved_NN/State-c4-cut_saved_entire_" + str(
        Home_model_or_away_model) + "_networks_feature" + str(
        FEATURE_TYPE) + "_batch" + str(BATCH_SIZE) + "_iterate" + str(
        ITERATE_NUM) + "_lr" + str(
        learning_rate) + "-" + str(
...
def parameter_setting(sess, model):
    state_average = [-1.42755875e-16, -8.74844181e-17, 9.44868703e-18, 2.16231185e-17,
                     ...
                     7.71782879e-17, 4.28205636e-13] * 4
