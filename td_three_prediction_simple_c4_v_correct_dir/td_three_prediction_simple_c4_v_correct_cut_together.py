...
LOG_DIR = save_mother_dir + "/oschulte/Galen/models/log_NN/Scale-three-c4-cut_log_entire_" + str(
...
SAVED_NETWORK = save_mother_dir + "/oschulte/Galen/models/saved_NN/Scale-three-c4-cut_saved_entire_" + str(
