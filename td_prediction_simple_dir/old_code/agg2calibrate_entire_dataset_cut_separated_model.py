...
ITERATE_NUM = 25
BATCH_SIZE = 32
calibration_store_dir = "/cs/oschulte/Galen/Hockey-data-entire/td_cut_calibrate_all_feature_" + str(
...
ISHOME = True
if ISHOME:
    save_csv_name = "td_cut_home_calibration_entire_feature_" + str(
        FEATURE_TYPE) + "_" + MODEL_TYPE + "_Iter" + str(ITERATE_NUM) + "_batch" + str(
        BATCH_SIZE) + "_sum_2017-6-17.csv"
    save_game_csv_name = "td_cut_home_game_record_entire_feature_" + str(
        FEATURE_TYPE) + "_" + MODEL_TYPE + "_Iter" + str(ITERATE_NUM) + "_batch" + str(
        BATCH_SIZE) + "_sum_2017-6-17.csv"
    data_home_name = "model_cut_predict_home_feature_" + str(
        FEATURE_TYPE) + "_" + MODEL_TYPE + "_Iter" + str(ITERATE_NUM) + "_batch" + str(BATCH_SIZE)
else:
    save_csv_name = "td_cut_away_calibration_entire_feature_" + str(FEATURE_TYPE) + "_" + MODEL_TYPE + "_Iter" + str(
        ITERATE_NUM) + "_batch" + str(BATCH_SIZE) + "_sum_2017-6-17.csv"
    save_game_csv_name = "td_cut_away_game_record_entire_feature_{0}_{1}_Iter{2}_batch{3}_sum_2017-6-17.csv".format(str(
