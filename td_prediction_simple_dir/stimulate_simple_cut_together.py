...
def nn_simulation(SIMULATION_DATA_PATH, SIMPLE_SAVED_NETWORK_PATH):
    ...
    #
    draw_value_over_position(readout_t1_batch[:, 0])
    draw_value_over_position(readout_t1_batch[:, 1])
    #
...
if __name__ == '__main__':
    ...
    model_nn = nn
    stimulate_value_home = nn_simulation(SIMULATION_HOME_DATA_PATH, SIMPLE_SAVED_NETWORK_PATH)
    stimulate_value_away = nn_simulation(SIMULATION_AWAY_DATA_PATH, SIMPLE_SAVED_NETWORK_PATH)
