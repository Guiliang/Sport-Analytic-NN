...
if Scale:
    DATA_STORE = "/cs/oschulte/Galen/Hockey-data-entire/TEST" + str(
        DATA_SIZE) + "-State-Hockey-Training-All-feature5-scale-" + "neg_reward"

    LOG_DIR = save_mother_dir + "/oschulte/Galen/models/log_NN/Test"+str(DATA_SIZE)+"-Scale-state-cut_log_entire_" + str(
    ...
    SAVED_NETWORK = save_mother_dir + "/oschulte/Galen/models/saved_NN/Test"+str(DATA_SIZE)+"-Scale-state-cut_saved_entire_" + str(
    ...
    DATA_STORE = "/cs/oschulte/Galen/Hockey-data-entire/TEST" + str(
        DATA_SIZE) + "-State-Hockey-Training-All-feature5-" + "neg_reward"

    LOG_DIR = save_mother_dir + "/oschulte/Galen/models/log_NN/Test"+str(DATA_SIZE)+"-state-cut_log_entire_" + str(
        Home_model_or_away_model) + "_train_feature" + str(
        FEATURE_TYPE) + "_batch" + str(BATCH_SIZE) + "_iterate" + str(
        ITERATE_NUM) + "_lr" + str(
        learning_rate) + "-" + str(
        REWARD_TYPE) + "_" + MODEL_TYPE + "-" + Random_or_Sequenced + pre_initialize_situation
    SAVED_NETWORK = save_mother_dir + "/oschulte/Galen/models/saved_NN/Test"+str(DATA_SIZE)+"-state-cut_saved_entire_" + str(
        Home_model_or_away_model) + "_networks_feature" + str(
        FEATURE_TYPE) + "_batch" + str(BATCH_SIZE) + "_iterate" + str(
        ITERATE_NUM) + "_lr" + str(
        learning_rate) + "-" + str(
