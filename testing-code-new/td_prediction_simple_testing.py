...
if Train:
    DATA_STORE = "/cs/oschulte/Galen/Hockey-data-entire/Test" + str(TEST_LENGTH) + "-Hockey-Training-All-feature" + str(
...
LOG_DIR = "/cs/oschulte/Galen/models/log_NN/Test" + str(TEST_LENGTH) + "-log_entire_" + "_train_feature" + str(
...
SAVED_NETWORK = "/cs/oschulte/Galen/models/saved_NN/Test" + str(
    TEST_LENGTH) + "-saved_entire_" + "_networks_feature" + str(
    FEATURE_TYPE) + "_batch" + str(BATCH_SIZE) + "_iterate" + str(
    ITERATE_NUM) + "-" + str(REWARD_TYPE) + "_" + MODEL_TYPE + TRAIN_or_TEST + "-" + Random_or_Sequenced
