...
if Home_model:
    LOG_DIR = "/cs/oschulte/Galen/models/hybrid_sl_log_NN/Test" + str(
        TEST_LENGTH) + "-cut_home_log_train_feature" + str(
    ...
    SAVED_NETWORK = "/cs/oschulte/Galen/models/hybrid_sl_saved_NN/Test" + str(
        TEST_LENGTH) + "-cut_home_saved_networks_feature" + str(
        FEATURE_TYPE) + "_batch" + str(
        BATCH_SIZE) + "_iterate" + str(
        ITERATE_NUM) + "_"+str(MODEL_TYPE)
    ...
    LOG_DIR = "/cs/oschulte/Galen/models/hybrid_sl_log_NN/Test" + str(
        TEST_LENGTH) + "-cut_away_log_train_feature" + str(
        FEATURE_TYPE) + "_batch" + str(
        BATCH_SIZE) + "_iterate" + str(
        ITERATE_NUM) + "_"+str(MODEL_TYPE)
    SAVED_NETWORK = "/cs/oschulte/Galen/models/hybrid_sl_saved_NN/Test" + str(
        TEST_LENGTH) + "-cut_away_saved_networks_feature" + str(
        FEATURE_TYPE) + "_batch" + str(
        BATCH_SIZE) + "_iterate" + str(
        ITERATE_NUM) + "_"+str(MODEL_TYPE)
