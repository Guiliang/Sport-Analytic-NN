...
calibration_store_dir = "/cs/oschulte/Galen/Hockey-data-entire/Test100-Hybrid-RNN-Hockey-Training-All-feature{0}-scale-neg_reward_length-dynamic".format(
    str(FEATURE_TYPE))

save_csv_name = "td_testing_lstm_cut_together_calibration_entire_feature_" + str(
    FEATURE_TYPE) + "_" + MODEL_TYPE + "_Iter" + str(ITERATE_NUM) + "_batch" + str(
    BATCH_SIZE) + "_sum_2017-7-03.csv"
save_game_csv_name = "td_testing_lstm_cut_together_game_record_entire_feature_" + str(
    FEATURE_TYPE) + "_" + MODEL_TYPE + "_Iter" + str(ITERATE_NUM) + "_batch" + str(
    BATCH_SIZE) + "_sum_2017-7-03.csv"
