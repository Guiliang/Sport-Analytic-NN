...
if SCALE:
    ...
    LOG_DIR = "/cs/oschulte/Galen/models/log_NN/Scale-dp-back-cut_log_entire_together_train_feature" + str(
    ...
    SAVED_NETWORK = "/cs/oschulte/Galen/models/saved_NN/Scale-dp-back-cut_saved_entire_together_networks_feature" + str(
        FEATURE_TYPE) + "_batch" + str(BATCH_SIZE) + "_iterate" + str(
        ITERATE_NUM) + "-" + str(REWARD_TYPE) + "_" + MODEL_TYPE + "-" + Random_or_Sequenced + pre_initialize_situation
else:
    DATA_STORE = "/cs/oschulte/Galen/Hockey-data-entire/Back-Hockey-Training-All-feature" + str(
        FEATURE_TYPE) + "-neg_reward"
    LOG_DIR = "/cs/oschulte/Galen/models/log_NN/dp-back-cut_log_entire_together_train_feature" + str(
        FEATURE_TYPE) + "_batch" + str(BATCH_SIZE) + "_iterate" + str(
        ITERATE_NUM) + "-" + str(REWARD_TYPE) + "_" + MODEL_TYPE + "-" + Random_or_Sequenced + pre_initialize_situation
    SAVED_NETWORK = "/cs/oschulte/Galen/models/saved_NN/dp-back-cut_saved_entire_together_networks_feature" + str(
        FEATURE_TYPE) + "_batch" + str(BATCH_SIZE) + "_iterate" + str(
        ITERATE_NUM) + "-" + str(REWARD_TYPE) + "_" + MODEL_TYPE + "-" + Random_or_Sequenced + pre_initialize_situation
            ...
            while True:
                ...
                for i in range(0, len(batch)):
                    ...
                    if last:
                        ...
                        y_away = (r_t_batch[i])[1] + GAMMA * ((readout_t1_batch[i]).tolist())[1]
