...
import numpy as np 
null = None
online_info_path = '/cs/oschulte/miyunLuo/Documents/Code/Soccer_ActSpkLodThGo_twoModel/action_value_k=10/online_info/Soccer_offensive.csv'
...
# name,team,Apps, | Mins,Goals,SpG,KeyP,Drb,Fouled,Off,Disp,UnsTch,Rating
