...
save_csv_name = home_or_away + "RNN_cut_together_calibration_entire_feature_" + str(
    FEATURE_TYPE) + "_" + MODEL_TYPE + "_Iter" + str(ITERATE_NUM) + "_batch" + str(
    BATCH_SIZE) + pre_initialize_save + "_sum_2017-7-17.csv"
save_game_csv_name = home_or_away + "RNN_cut_together_game_record_entire_feature_" + str(
    FEATURE_TYPE) + "_" + MODEL_TYPE + "_Iter" + str(ITERATE_NUM) + "_batch" + str(
    BATCH_SIZE) + pre_initialize_save + "_sum_2017-7-17.csv"

data_together_name = "model_cut_fix_rnn_together_predict_feature_" + str(
    FEATURE_TYPE) + "_" + MODEL_TYPE + "_Iter" + str(ITERATE_NUM) + "_batch" + str(
    BATCH_SIZE) + pre_initialize_save + ".mat"
data_together_name_load_name = "model_cut_fix_rnn_together_predict_feature_" + str(
