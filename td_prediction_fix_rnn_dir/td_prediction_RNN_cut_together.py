...
if SCALE:
    LOG_DIR = save_mother_dir + "/oschulte/Galen/models/log_NN/Scale-fix_rnn_cut_together_log_train_feature" + str(
        FEATURE_TYPE) + "_batch" + str(
        BATCH_SIZE) + "_iterate" + str(
        ITERATE_NUM) + "_" + str(MODEL_TYPE)
    SAVED_NETWORK = save_mother_dir + "/oschulte/Galen/models/saved_NN/Scale-fix_rnn_cut_together_saved_networks_feature" + str(
        FEATURE_TYPE) + "_batch" + str(
        BATCH_SIZE) + "_iterate" + str(
        ITERATE_NUM) + "_" + str(MODEL_TYPE)
    DATA_STORE = "/cs/oschulte/Galen/Hockey-data-entire/RNN-Hockey-Training-All-feature{0}-scale-neg_reward_length-{1}".format(
        str(FEATURE_TYPE), str(TRACE_LENGTH))
else:
    LOG_DIR = save_mother_dir + "/oschulte/Galen/models/log_NN/fix_rnn_cut_together_log_train_feature" + str(
        FEATURE_TYPE) + "_batch" + str(
        BATCH_SIZE) + "_iterate" + str(
        ITERATE_NUM) + "_" + str(MODEL_TYPE)
    SAVED_NETWORK = save_mother_dir + "/oschulte/Galen/models/saved_NN/fix_rnn_cut_together_saved_networks_feature" + str(
        FEATURE_TYPE) + "_batch" + str(
        BATCH_SIZE) + "_iterate" + str(
        ITERATE_NUM) + "_" + str(MODEL_TYPE)
    DATA_STORE = "/cs/oschulte/Galen/Hockey-data-entire/RNN-Hockey-Training-All-feature{0}-neg_reward_length-{1}".format(
        str(FEATURE_TYPE), str(TRACE_LENGTH))
