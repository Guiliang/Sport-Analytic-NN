...
import unicodedata
import ast
import td_three_prediction_simple_cut_together
import numpy as np
...
MODEL_TYPE = "V3"
BATCH_SIZE = 32
td_three_prediction_simple_cut_together.feature_num = 26
...
SIMPLE_SAVED_NETWORK_PATH = "/cs/oschulte/Galen/models/saved_NN/Scale-three-cut_saved_entire_together_networks_feature{0}_batch{1}_iterate{2}_lr{3}-NEG_REWARD_GAMMA1_{4}-Sequenced{5}".format(
...
"Scale-three-cut_saved_entire_together_networks_feature5_batch32_iterate50_lr1e-05-NEG_REWARD_GAMMA1_V3-Sequenced"
...
if MODEL_TYPE == "V3":
    model_nn = td_three_prediction_simple_cut_together.td_prediction_simple_V3()
# elif MODEL_TYPE == "V4":
